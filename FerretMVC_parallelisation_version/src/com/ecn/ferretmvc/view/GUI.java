...
//    JSlider mafSliderMax = new JSlider(0, 5000, 0);
    ...
    JRadioButton no_annot = new JRadioButton("Allele Frequencies without annotations [default]");
    JRadioButton default_annot = new JRadioButton("Allele Frequencies + default annotations");
    JRadioButton advanced_annot = new JRadioButton("Allele Frequencies + advanced annotations");
    ...
    JLabel annotLabel = new JLabel("Annotations");
    ...
    public JRadioButton getno_annot() {
        return no_annot;
    }
    public JRadioButton getdefault_annot() {
        return default_annot;
    }
    public JRadioButton getadvanced_annot() {
        return advanced_annot;
    }
...
//        mafPanel.add(mafSliderMax);
        ...
        annotLabel.setFont(new Font("SansSerif", Font.BOLD, 16));
        settingsPanel.add(annotLabel);
...
//        settingsPanel.add(advanced_annot);
        ...
        no_annot.setActionCommand("no_annot");
        default_annot.setActionCommand("default_annot");
        advanced_annot.setActionCommand("advanced_annot");
    ...
    public void settingsListener(ActionListener a) {
        ...
        no_annot.addActionListener(a);
        default_annot.addActionListener(a);
