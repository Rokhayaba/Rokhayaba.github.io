...
public class Test_para1 {
	...
	//ExecutorService executor = Executors.newFixedThreadPool(MYTHREADS);
		 ...
		 try {
             ...
             File testfile = new File("C:\\Users\\e300264\\Documents\\Projet_Ferret\\Fichiers\\testfile");
             PrintWriter writer = new PrintWriter(new BufferedWriter(new FileWriter(testfile)));
             writer.print("geneSymbol\t" + aa2+ "\n");
             writer.close();
     		//executor.shutdown();
